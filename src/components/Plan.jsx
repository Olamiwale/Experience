...
export default function Plan (){
  return (
    <div className='m-auto py-16 px-4 grid lg:grid-cols-2 gap-4  '>
        
      <div className='grid grid-cols-3 grid-rows-5'>
        <img
          className='row-span-5 object-cover w-full h-full p-2'
      ...
      <div className='flex flex-col h-full justify-center'>
        <h3 className='text-5xl max-md:text-3xl font-bold'>Plan Your Next Trip</h3>
        <p className='font-bold text-2xl py-6 max-md:text-xl'>
        ...
        <div>
          <button className='border rounded-full p-4 px-6 m-2'>
            Learn More
          </button>
          <button className='border rounded-full p-4 px-6'>Book Your Trip</button>
        </div>
      </div>
    </div>
  );
